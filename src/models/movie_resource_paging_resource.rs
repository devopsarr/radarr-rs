...
pub struct MovieResourcePagingResource {
    ...
    pub records: Option<Option<Vec<models::MovieResource>>>,
}

impl MovieResourcePagingResource {
    pub fn new() -> MovieResourcePagingResource {
