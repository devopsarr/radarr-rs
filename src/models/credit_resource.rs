...
pub struct CreditResource {
    ...
    pub id: Option<i32>,
    #[serde(rename = "personName", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub person_name: Option<Option<String>>,
    #[serde(rename = "creditTmdbId", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
