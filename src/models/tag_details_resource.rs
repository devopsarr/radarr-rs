...
pub struct TagDetailsResource {
    ...
    #[serde(rename = "releaseProfileIds", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub release_profile_ids: Option<Option<Vec<i32>>>,
